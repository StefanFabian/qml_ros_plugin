...
bool convertToFormat( const sensor_msgs::Image &img, QVideoFrame::PixelFormat format,
...
convertToClosestFormat( const sensor_msgs::Image &img, uint8_t **data, int &num_bytes,
...
QVideoFrame::PixelFormat convertFrame( const sensor_msgs::Image &img, uint8_t **data,
